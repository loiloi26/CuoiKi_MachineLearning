...
| Stochastic Gradient Descent (SGD) |     -Đánh giá ngay lập tức hiệu suất mô   hình và tỷ lệ cải tiến.     -Dễ hiểu và dễ thực hiện, đặc biệt   dành cho người mới bắt đầu.     - Cập nhật nhanh hơn tạo điều kiện   phát hiện vấn đề nhanh hơn.     -Tránh các cực tiểu cục bộ với quá   trình cập nhật nhiễu.     -Nhanh hơn và đòi hỏi ít sức mạnh tính   toán hơn.     -Thích hợp cho các tập dữ liệu lớn   hơn.    |     - Tính toán chuyên sâu, đặc biệt với   các tập dữ liệu lớn.     - Cập nhật nhiễu có thể dẫn đến sự   khác biệt giữa các epochs.     -Quá trình học nhiễu có thể gây khó   khăn cho việc cam kết sai số tối thiểu của mô hình.                                                        |
|                                   |                                                                                                                                                                                                                                                                                                                                                                                    |                                                                                                                                                                                                                                                                                          |
|                                   |                                                                                                                                                                                                                                                                                                                                                                                    |                                                                                                                                                                                                                                                                                          |
|                                   |                                                                                                                                                                                                                                                                                                                                                                                    |                                                                                                                                                                                                                                                                                          |
|                                   |                                                                                                                                                                                                                                                                                                                                                                                    |                                                                                                                                                                                                                                                                                          |
